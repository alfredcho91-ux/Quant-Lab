...
type ExitHoldInterval = '15m' | '1h' | '4h' | '1d';
...
const STANDARD_METRIC_ORDER: JournalMetricId[] = [
  'netReturn', 'netPnl', 'winRate', 'profitFactor', 'averageWin',
  'averageLoss', 'expectancy', 'costImpact', 'holdingTime',
];
...
export const TRADING_STYLE_CONFIGS: Record<TradingStyle, TradingStyleConfig> = {
  auto: {
    id: 'auto', labelKo: '자동', labelEn: 'Auto', defaultTimeframe: '4h', defaultExitHoldInterval: '4h',
    analysisOrder: STANDARD_ANALYSIS_ORDER, journalMetricOrder: STANDARD_METRIC_ORDER,
  },
  scalper: {
    id: 'scalper', labelKo: '스캘퍼', labelEn: 'Scalper', defaultTimeframe: '1h', defaultExitHoldInterval: '15m',
  ...
  day: {
    id: 'day', labelKo: '데이트레이더', labelEn: 'Day trader', defaultTimeframe: '1h', defaultExitHoldInterval: '15m',
    analysisOrder: ['execution', 'indicators', 'market'],
    journalMetricOrder: ['netReturn', 'netPnl', 'winRate', 'profitFactor', 'holdingTime', 'expectancy', 'costImpact', 'averageWin', 'averageLoss'],
  },
  swing: {
    id: 'swing', labelKo: '스윙 트레이더', labelEn: 'Swing trader', defaultTimeframe: '4h', defaultExitHoldInterval: '4h',
  ...
  position: {
    id: 'position', labelKo: '포지션 트레이더', labelEn: 'Position trader', defaultTimeframe: '1d', defaultExitHoldInterval: '1d',
    analysisOrder: ['market', 'execution', 'indicators'],
    journalMetricOrder: ['netReturn', 'netPnl', 'holdingTime', 'profitFactor', 'winRate', 'expectancy', 'averageWin', 'averageLoss', 'costImpact'],
  },
  custom: {
    id: 'custom', labelKo: '사용자 지정', labelEn: 'Custom', defaultTimeframe: '4h', defaultExitHoldInterval: '4h',
    analysisOrder: STANDARD_ANALYSIS_ORDER, journalMetricOrder: STANDARD_METRIC_ORDER,
  },
};
