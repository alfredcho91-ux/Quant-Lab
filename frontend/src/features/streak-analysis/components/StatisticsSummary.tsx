      ...
      {result.mode === 'complex' && (
        <div className="card p-6">
          ...
          {result.complex_pattern_analysis?.summary?.c1_analysis && (
            <div className="mt-6 p-6 bg-gradient-to-r from-emerald-500/10 via-rose-500/10 to-emerald-500/10 border border-dark-700 rounded-xl">
                ...
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-3xl font-bold text-emerald-400">
                      {result.complex_pattern_analysis.summary.c1_analysis.green_rate.toFixed(1)}%
                    </span>
                  </div>
                  ...
                  {result.complex_pattern_analysis.summary.c1_analysis.green_confidence_interval && (
                    <div className="text-xs text-dark-500 mt-1">
                      {isKo ? '95% 신뢰구간' : '95% CI'}: [
                      {result.complex_pattern_analysis.summary.c1_analysis.green_confidence_interval[0].toFixed(1)}%,
                      {result.complex_pattern_analysis.summary.c1_analysis.green_confidence_interval[1].toFixed(1)}%]
                    </div>
                  )}
                </div>
                ...
                <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-3xl font-bold text-rose-400">
                      {result.complex_pattern_analysis.summary.c1_analysis.red_rate.toFixed(1)}%
                    </span>
                  </div>
                  <div className="text-xs text-dark-500">
                    {isKo
                  ...
                  {result.complex_pattern_analysis.summary.c1_analysis.red_confidence_interval && (
                    <div className="text-xs text-dark-500 mt-1">
                      {isKo ? '95% 신뢰구간' : '95% CI'}: [
                      {result.complex_pattern_analysis.summary.c1_analysis.red_confidence_interval[0].toFixed(1)}%,
                      {result.complex_pattern_analysis.summary.c1_analysis.red_confidence_interval[1].toFixed(1)}%]
                    </div>
                  )}
                </div>
              </div>
