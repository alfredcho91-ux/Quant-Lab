...
sequenceDiagram
    ...
    participant COMP as complex_strategy.py
...
**패턴 매칭 로직** (`common.py::find_complex_pattern`):
...
**되돌림 비율 계산** (`common.py::analyze_pullback_quality`):
...
**시그널 점수 계산** (`common.py::calculate_signal_score`):
