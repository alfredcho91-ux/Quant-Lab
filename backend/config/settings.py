...
# Preset settings
PRESET_DIR = Path(os.getenv("PRESET_DIR", str(PROJECT_ROOT / "data"))).expanduser()
PRESETS_FILE = Path(
    os.getenv("PRESETS_FILE", str(PRESET_DIR / "presets.json"))
).expanduser()
LEGACY_PRESETS_FILE = PROJECT_ROOT / "presets.json"
